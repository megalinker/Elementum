        ...
        <form className="form-component" onSubmit={handleSubmit}>
            ...
            <div className="input-wrapper">
                ...
                <div className="input-content">
                    ...
                    <input type="email" placeholder="E-mail" className="form-input" value={email} onChange={(e) => setEmail(e.target.value)} required/>
                </div>
            </div>
            ...
            <PurpleButtonComponent onClick={() => handleSubmit}>
                Submit
